	...
	fetch(`https://amiiboapi.com/api/${url}=${textInput.value}`)
		...
		.then((datos) => {
			...
			if (datos.amiibo.length != 0) {
				...
				gif.src =
					"https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExdGtyY25jc2wzNjZzZDVrYjZqYnY1MTE2c3h4OGp3b3I3NWkwcjN0dCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/pyJsNhs040q79RNeVA/giphy.gif";
